...
type WithOptionalChain<T extends { chain: SuiSignTransactionInput["chain"] }> =
  Omit<T, "chain"> & Partial<Pick<T, "chain">>;
...
export interface WalletAdapter {
  ...
  signTransaction(
    transactionInput: WithOptionalChain<SuiSignTransactionInput>
  ): Promise<SignedTransaction>;
  /**
   * Suggest a transaction for the user to sign. Supports all valid transaction types.
   */
  signAndExecuteTransaction(
    transactionInput: WithOptionalChain<SuiSignAndExecuteTransactionInput>
